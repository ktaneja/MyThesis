...
\em\usepackage{booktabs}  % professionally typeset tables
\usepackage{amsmath}
\usepackage{xcolor}
...
\memberI{A}
\memberII{B}
\memberIII{C} % unnecessary if committeesize=3

%% Student writing thesis, \student{first middle}{last}
\student{Kunal Taneja}{} % a full middle name
...
\thesistitle{Cost Reduction and Quiality Improvement of Softwre Maintenance}
